...
<a
	href="#main"
	class="sr-only z-50 rounded-md bg-accent px-3 py-2 text-sm font-medium text-accent-fg focus:not-sr-only focus:fixed focus:top-3 focus:left-3"
>
	Skip to content
</a>
...
<div
	class={`flex min-h-dvh flex-col transition-[padding] duration-200 ${collapsed ? 'md:pl-16' : 'md:pl-64'}`}
>
